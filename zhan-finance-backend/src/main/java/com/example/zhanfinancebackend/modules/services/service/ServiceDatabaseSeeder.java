...
public class ServiceDatabaseSeeder {
    ...
    public void seedDatabase() {
        ...
        List<ServiceEntity> services = Arrays.asList(
                ...
                createService("Проверка и анализ контрагентов", "Counterparty Analysis", "Налоговая проверка благонадежности партнеров и клиентов перед сделкой.", "Tax verification of reliability of partners and clients before a deal.", "от 10 000 ₸", true, Arrays.asList("Проверка по реестрам КГД", "Анализ налоговых рисков", "Рекомендации по сотрудничеству"))
        );
