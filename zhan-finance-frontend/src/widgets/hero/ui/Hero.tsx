          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="h-16 px-12 rounded-xl bg-brand-green text-brand-beige inline-flex items-center justify-center text-lg font-bold uppercase tracking-wider shadow-xl shadow-brand-green/15"
              >
                Начать
              </motion.a>
            </motion.div>
          ...
          <div className="lg:col-span-5 hidden lg:flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: [0, -10, 0], rotate: -2, scale: 1 }}
                transition={{
              ...
              >
                ...
                <div className="flex items-end justify-between">
                  <span className="text-brand-beige/90 text-3xl font-black tracking-tight">100%</span>
                  <span className="text-brand-beige/60 text-xs font-semibold uppercase tracking-wider">надёжность</span>
                </div>
              </motion.div>
