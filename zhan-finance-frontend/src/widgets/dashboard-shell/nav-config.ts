...
export const navConfig: Record<UserRole, NavItem[]> = {
  ADMIN: [
    ...
    { label: 'Curators', href: ROUTES.ADMIN_CURATORS },
  ...
  EMPLOYEE: [
    ...
    { label: 'Leads', href: ROUTES.ADMIN_LEADS },
    { label: 'Tasks', href: ROUTES.EMPLOYEE_TASKS },
    { label: 'Task Pool', href: ROUTES.EMPLOYEE_TASK_POOL },
    { label: 'Documents', href: ROUTES.EMPLOYEE_DOCUMENTS },
    { label: 'Settings', href: ROUTES.SETTINGS },
    { label: 'Notifications', href: ROUTES.NOTIFICATIONS },
  ],
  CURATOR: [
    { label: 'Overview', href: ROUTES.CURATOR },
    { label: 'My Courses', href: ROUTES.CURATOR_COURSES },
    { label: 'Students', href: ROUTES.CURATOR_STUDENTS },
    { label: 'Settings', href: ROUTES.SETTINGS },
    { label: 'Notifications', href: ROUTES.NOTIFICATIONS },
  ],
  CLIENT: [
    { label: 'Overview', href: ROUTES.CLIENT },
    { label: '1C Reports', href: ROUTES.CLIENT_1C_REPORTS },
  ...
  ADVISOR: [
    { label: 'Overview', href: ROUTES.ADVISOR },
    { label: 'Team Workload', href: ROUTES.ADVISOR_WORKLOAD },
