      ...
      <Container>
        <div className="flex h-20 items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-2xl font-bold text-brand-green tracking-tight">Zhan<span className="font-light">Finance</span></span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:inline-flex px-6 py-2.5 bg-brand-green text-brand-beige rounded-full text-sm font-bold hover:bg-brand-green/90 transition-all hover:scale-105 shadow-xl shadow-brand-green/20">
              Связаться
            </button>
          </div>
        </div>
