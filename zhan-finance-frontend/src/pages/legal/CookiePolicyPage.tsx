        ...
        <div className="bg-brand-green text-brand-beige rounded-3xl p-8 md:p-12 mb-10 shadow-lg relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-brand-beige/80 text-base md:text-lg max-w-2xl">
                Информация о том, какие файлы cookie и технологии локального хранения используются платформой ЖАН FINANCE, для чего они нужны и как вы можете ими управлять.
              </p>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-brand-green/10 text-brand-green/90 space-y-10 leading-relaxed font-normal">
            ...
            <section className="space-y-4">
              ...
              <p>
                1.2. Наряду с cookie платформа ЖАН FINANCE использует современное веб-хранилище браузера (LocalStorage и SessionStorage) исключительно для сохранения языковых настроек и визуального комфорта работы.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-2xl border border-brand-green/10 bg-brand-beige/30 space-y-2">
                  ...
                  <p className="text-xs text-brand-green/80">
                    Позволяют запомнить выбранный язык и настройки представления задач. Не отслеживают ваши действия за пределами ЖАН FINANCE.
                  </p>
                </div>
              </div>
            </section>
