      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="bg-brand-green text-brand-beige rounded-3xl p-8 md:p-12 mb-10 shadow-lg relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-brand-beige/80 text-base md:text-lg max-w-2xl">
              Условия, сроки и порядок возврата денежных средств за подписки на SaaS-сервис ЖАН FINANCE и сопутствующие бухгалтерские услуги.
            </p>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-brand-green/10 text-brand-green/90 space-y-10 leading-relaxed font-normal">
          ...
          <section className="space-y-4">
            ...
            <p>
              1.1. Настоящая Политика возврата денежных средств (далее — «Политика») определяет правила и порядок возврата оплаты за тарифные подписки и разовые бухгалтерские услуги, предоставляемые ТОО «ЖАН FINANCE» (далее — «Компания»).
            </p>
            <p>
