      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="bg-brand-green text-brand-beige rounded-3xl p-8 md:p-12 mb-10 shadow-lg relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-brand-beige/80 text-base md:text-lg max-w-2xl">
              Договор публичной оферты на предоставление доступа к SaaS-платформе ЖАН FINANCE и оказание услуг бухгалтерского обслуживания.
            </p>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-brand-green/10 text-brand-green/90 space-y-10 leading-relaxed font-normal">
          ...
          <section className="space-y-4">
            ...
            <p>
              1.1. <strong>Исполнитель</strong> — ТОО «ЖАН FINANCE» (БИН 240140023819), предоставляющее доступ к SaaS-платформе и оказывающее профессиональные услуги.
            </p>
            <p>
            ...
            <p>
              1.3. <strong>Платформа</strong> — облачный программный комплекс ЖАН FINANCE, доступный в сети Интернет, предназначенный для управления бухгалтерскими задачами, документооборотом и коммуникациями.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              5.1. Все исключительные права на Платформу ZhanFinance, включая исходный код, базы данных, интерфейсные решения, алгоритмы расчета и товарные знаки, принадлежат ТОО «ЖАН FINANCE».
            </p>
            <p>
          ...
          <section className="space-y-4 pt-4 border-t border-brand-green/10">
            ...
            <div className="p-6 rounded-2xl bg-brand-beige/40 border border-brand-green/15 text-sm space-y-2">
              <p><strong>Исполнитель:</strong> ТОО «ЖАН FINANCE»</p>
