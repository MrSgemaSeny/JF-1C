...
export function AdvisorOverviewPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 space-y-8">
      ...
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-3xl border border-gray-200/80 shadow-2xs">
        <div>
            ...
            {employees.slice(0, 5).map((emp) => {
              ...
              return (
                <div key={emp.id} className="flex items-center justify-between p-4 rounded-2xl bg-gray-50/70 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-emerald-100/70 text-brand-green flex items-center justify-center font-black text-sm">
