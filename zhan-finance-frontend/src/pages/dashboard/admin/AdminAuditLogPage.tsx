    ...
    <Container className="py-8">
      <Section>
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm">System activity history</p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="p-3 text-sm font-medium text-gray-500">Entity ID</th>
                  <th className="p-3 text-sm font-medium text-gray-500">User ID</th>
