...
- [x] micrometer-registry-prometheus подключён
- [x] DB backup через GitHub Actions + Telegram

## Planned
- [ ] US-10.1 — Prometheus + Grafana на Fly.io
- [ ] US-10.2 — Sentry для error tracking (backend + frontend)
